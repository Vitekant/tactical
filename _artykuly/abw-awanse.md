...
1. **Staż w dotychczasowym stopniu (wysługa):**
...
2. **Pozytywna ocena służbowa** — posiadanie aktualnej, pozytywnej opinii oraz brak kar dyscyplinarnych.
3. **Przygotowanie zawodowe** — przejście do korpusu oficerskiego uwarunkowane jest pomyślnym ukończeniem szkolenia oficerskiego w Centralnym Ośrodku Szkolenia ABW i zdaniem egzaminu oficerskiego lub posiadaniem stopnia oficerskiego przeniesionego z innej służby.
